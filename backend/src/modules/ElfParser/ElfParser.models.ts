...
const Elf64RelocationWithAddendD = defineStruct({
  name: "Elf64Rela",
  fields: [
    { name: "r_offset", type: "uint64" }, // Address
    { name: "r_info", type: "uint64" }, // Relocation type and symbol index
    { name: "r_addend", type: "int64" }, // Addend
  ],
});
export const Elf64RelocationWithAddendL = new StructLayoutGenerator(Elf64RelocationWithAddendD);

// 64-bit Relocation Entry without Addend
const Elf64RelocationD = defineStruct({
  name: "Elf64Rel",
  fields: [
    { name: "r_offset", type: "uint64" },
    { name: "r_info", type: "uint64" },
  ],
});
export const Elf64RelocationL = new StructLayoutGenerator(Elf64RelocationD);

// 32-bit Relocation Entry with Addend
const Elf32RelocationWithAddendD = defineStruct({
  name: "Elf32Rela",
  fields: [
    { name: "r_offset", type: "uint32" },
    { name: "r_info", type: "uint32" },
    { name: "r_addend", type: "int32" },
  ],
});
export const Elf32RelocationWithAddendL = new StructLayoutGenerator(Elf32RelocationWithAddendD);

// 32-bit Relocation Entry without Addend
const Elf32RelocationD = defineStruct({
  name: "Elf32Rel",
  fields: [
    { name: "r_offset", type: "uint32" },
    { name: "r_info", type: "uint32" },
...
export const Elf32RelocationL = new StructLayoutGenerator(Elf32RelocationD);

// 64-bit Dynamic Section Entry
const Elf64DynamicD = defineStruct({
  name: "Elf64Dyn",
  fields: [
    { name: "d_tag", type: "int64" }, // Dynamic entry type
    { name: "d_un", type: "uint64" }, // Integer or address value
  ],
});
export const Elf64DynamicL = new StructLayoutGenerator(Elf64DynamicD);

// 32-bit Dynamic Section Entry
const Elf32DynamicD = defineStruct({
  name: "Elf32Dyn",
  fields: [
    { name: "d_tag", type: "int32" },
    { name: "d_un", type: "uint32" },
  ],
});
export const Elf32DynamicL = new StructLayoutGenerator(Elf32DynamicD);

// Note Section Header
const ElfNoteHeaderD = defineStruct({
  name: "ElfNhdr",
  fields: [
    { name: "n_namesz", type: "uint32" }, // Length of the note's name
    { name: "n_descsz", type: "uint32" }, // Length of the note's descriptor
    { name: "n_type", type: "uint32" }, // Type of the note
  ],
});
export const ElfNoteHeaderL = new StructLayoutGenerator(ElfNoteHeaderD);
