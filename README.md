...
This project is not just software. It is an effort to document the process of reading memory of mono applications. Every step is carefully explained in a [Vitepress documentation](https://github.com/TODO) so that you could make your own memory reading client if you wanted to. You can learn about:
...
Everything that you need to know is in the [documentation](https://github.com/TODO)
