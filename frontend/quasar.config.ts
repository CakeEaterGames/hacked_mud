...
export default defineConfig((/* ctx */) => {
  return {
    ...
    build: {
      ...
      publicPath: process.env.DASHBOARD_FRONTEND_BASE_URL!,
      // analyze: true,
    ...
    framework: {
      config: {
        dark: "auto" //auto or true to always enable, false to disable
        // dark: true //auto or true to always enable, false to disable
      },
